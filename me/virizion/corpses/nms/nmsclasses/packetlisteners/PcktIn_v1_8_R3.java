...
import net.minecraft.server.v1_10_R3.NetworkManager;
import net.minecraft.server.v1_10_R3.PacketPlayInUseEntity;
import net.minecraft.server.v1_10_R3.PacketPlayInUseEntity.EnumEntityUseAction;

import org.bukkit.Bukkit;
import org.bukkit.craftbukkit.v1_10_R3.entity.CraftPlayer;
import org.bukkit.entity.Player;

public class PcktIn_v1_10_R3 extends ChannelInboundHandlerAdapter {

	private Player p;

	public PcktIn_v1_10_R3(Player p) {
		this.p = p;
	}
